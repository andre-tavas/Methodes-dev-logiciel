...
int main(void) {
 ...
 // 10 Constructeur par defaut complexe_t a chaque fois
 Vecteur v1;
 Vecteur v2;
 ...
 // CONSTRUCTEUR AD HOC ET AFFECTATION DE MOUVEMENT
 ...
 // CONSTRUCTEUR PAR COPIE DE VECTEUR (appelle le constructeur par default de complexe après fait des affectation par copie)
 Vecteur v3 = v1; // CONSTRUCTION, COPIE ET AFFECTATION
