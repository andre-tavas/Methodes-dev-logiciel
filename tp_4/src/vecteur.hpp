...
inline Vecteur operator+(const Vecteur & v1,const Vecteur & v2) {
 Vecteur v; // constructeurs par defaut

// v1[i]+v2[i] -> construction ad hoc retorna rvalue
// v1[i]+v2[i] -> construction ad hoc + affectation par mouvement pcq affecta rvalue

 for (unsigned i = 0; i<v1.getTaille(); ++i) v[i]=v1[i]+v2[i]; // retorna rvalue
